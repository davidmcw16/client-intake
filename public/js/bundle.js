(() => {
      ...
      equals(type, a2, b2) {
        ...
        return type.fields.byMember().every((m2) => {
          ...
          if (m2.repeated) {
            ...
            switch (m2.kind) {
              case "message":
                return va.every((a3, i) => m2.T.equals(a3, vb[i]));
              case "scalar":
                return va.every((a3, i) => scalarEquals(m2.T, a3, vb[i]));
              case "enum":
                return va.every((a3, i) => scalarEquals(ScalarType.INT32, a3, vb[i]));
            }
      ...
      return new Promise(function(i2, t2) {
        ...
        if (void 0 !== o2 && clearTimeout(o2), o2 = setTimeout(function() {
          if (o2 = void 0, v2 = Date.now(), !a2) {
            ...
            u2 && u2(i3), l2.forEach(function(r4) {
  ...
  var r2 = class {
    static getFullOptions(e2) {
      ...
      const n = (function(e3) {
        var t2, n2;
        const { textOnly: o2 } = null != (t2 = null == (n2 = e3.overrides) ? void 0 : n2.conversation) ? t2 : {}, { textOnly: i } = e3;
        return "boolean" == typeof i ? ("boolean" == typeof o2 && i !== o2 && console.warn(`Conflicting textOnly options provided: ${i} via options.textOnly (will be used) and ${o2} via options.overrides.conversation.textOnly (will be ignored)`), i) : "boolean" == typeof o2 ? o2 : void 0;
      })(e2);
      ...
      } }, e2, { textOnly: n, overrides: s({}, e2.overrides, { conversation: s({}, null == (t = e2.overrides) ? void 0 : t.conversation, { textOnly: n }) }) });
    }
    constructor(e2, t) {
      var n = this;
    ...
    handleAgentResponse(e2) {
      this.options.onMessage && this.options.onMessage({ source: "ai", role: "agent", message: e2.agent_response_event.agent_response, event_id: e2.agent_response_event.event_id });
    }
    handleUserTranscript(e2) {
      this.options.onMessage && this.options.onMessage({ source: "user", role: "user", message: e2.user_transcription_event.user_transcript, event_id: e2.user_transcription_event.event_id });
    }
  ...
  function p(e2) {
    var t;
    const n = { type: h2 };
    var o2, i, s2, a2, r3, c2, l2, u2;
    return e2.overrides && (n.conversation_config_override = { agent: { prompt: null == (o2 = e2.overrides.agent) ? void 0 : o2.prompt, first_message: null == (i = e2.overrides.agent) ? void 0 : i.firstMessage, language: null == (s2 = e2.overrides.agent) ? void 0 : s2.language }, tts: { voice_id: null == (a2 = e2.overrides.tts) ? void 0 : a2.voiceId, speed: null == (r3 = e2.overrides.tts) ? void 0 : r3.speed, stability: null == (c2 = e2.overrides.tts) ? void 0 : c2.stability, similarity_boost: null == (l2 = e2.overrides.tts) ? void 0 : l2.similarityBoost }, conversation: { text_only: null == (u2 = e2.overrides.conversation) ? void 0 : u2.textOnly } }), e2.customLlmExtraBody && (n.custom_llm_extra_body = e2.customLlmExtraBody), e2.dynamicVariables && (n.dynamic_variables = e2.dynamicVariables), e2.userId && (n.user_id = e2.userId), null != (t = e2.overrides) && t.client && (n.source_info = { source: e2.overrides.client.source, version: e2.overrides.client.version }), n;
  }
  var m = class extends Error {
    constructor(e2, t) {
      super(e2), this.closeCode = void 0, this.closeReason = void 0, this.name = "SessionConnectionError", this.closeCode = null == t ? void 0 : t.closeCode, this.closeReason = null == t ? void 0 : t.closeReason;
    }
  };
  var v = class _v extends c {
    constructor(e2, t, n, o2) {
      super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e2, this.conversationId = t, this.inputFormat = n, this.outputFormat = o2, this.socket.addEventListener("error", (e3) => {
        ...
        this.disconnect(1e3 === e3.code ? { reason: "agent", context: e3, closeCode: e3.code, closeReason: e3.reason || void 0 } : { reason: "error", message: e3.reason || "The connection was closed by the server.", context: e3, closeCode: e3.code, closeReason: e3.reason || void 0 });
    ...
    static async create(e2) {
      ...
      try {
        ...
        let a2;
        const r3 = (null == (o2 = e2.overrides) || null == (o2 = o2.client) ? void 0 : o2.version) || u, c2 = (null == (i = e2.overrides) || null == (i = i.client) ? void 0 : i.source) || "js_sdk";
        if (e2.signedUrl) {
        ...
        const g2 = await new Promise((n2, o3) => {
          t.addEventListener("open", () => {
            ...
            setTimeout(() => o3(new m("The connection was closed due to a socket error.")), 0);
          }), t.addEventListener("close", (e3) => {
            o3(new m(e3.reason || (1e3 === e3.code ? "Connection closed normally before session could be established." : "Connection closed unexpectedly before session could be established."), { closeCode: e3.code, closeReason: e3.reason || void 0 }));
          }), t.addEventListener("message", (e3) => {
            const t2 = JSON.parse(e3.data);
        ...
        }), { conversation_id: f2, agent_output_audio_format: _3, user_input_audio_format: w2 } = g2, b2 = l(null != w2 ? w2 : "pcm_16000"), y2 = l(_3);
        return new _v(t, f2, b2, y2);
      } catch (e3) {
        var s2;
  ...
  function w(e2, t) {
    return async (n, o2) => {
      ...
      if (o2) try {
        return await n.addModule(o2), void _2.set(e2, o2);
      } catch (t2) {
        throw new Error(`Failed to load the ${e2} worklet module from path: ${o2}. Error: ${t2}`);
      }
      const s2 = new Blob([t], { type: "application/javascript" }), a2 = URL.createObjectURL(s2);
      try {
      ...
      try {
        ...
        await n.addModule(o3), _2.set(e2, o3);
      } catch (t2) {
...
`);
  var y = class _y extends c {
    ...
    static async create(n) {
      ...
      if ("conversationToken" in n && n.conversationToken) o2 = n.conversationToken;
        ...
        try {
          var i, s2, a2;
          const e2 = (null == (i = n.overrides) || null == (i = i.client) ? void 0 : i.version) || u, t = (null == (s2 = n.overrides) || null == (s2 = s2.client) ? void 0 : s2.source) || "js_sdk", c3 = `${r3 = null != (a2 = n.origin) ? a2 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, l2 = await fetch(c3);
      ...
      const c2 = new Room();
      try {
        const e2 = `room_${Date.now()}`, i2 = l("pcm_48000"), s3 = l("pcm_48000"), a3 = new _y(c2, e2, i2, s3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
        var d2;
        await c2.connect(r4, o2), await new Promise((e3) => {
          if (a3.isConnected) e3();
          else {
            const n2 = () => {
        ...
        }), c2.name && (a3.conversationId = (null == (d2 = c2.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d2[0]) || c2.name), n.textOnly || await c2.localParticipant.setMicrophoneEnabled(true);
        const u2 = p(n);
        return a3.debug({ type: h2, message: u2 }), await a3.sendMessage(u2), a3;
      } catch (e2) {
    ...
    setupRoomEventListeners() {
      ...
      }), this.room.on(RoomEvent.TrackSubscribed, async function(t, n, i) {
        if (t.kind === Track.Kind.Audio && i.identity.includes("agent")) {
    ...
    async setupAudioCapture(e2) {
      try {
        ...
        o2.connect(this.outputAnalyser), await b(t.audioWorklet);
        const i = new AudioWorkletNode(t, "rawAudioProcessor");
        this.outputAnalyser.connect(i), i.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), i.port.onmessage = (e3) => {
          const [t2, n2] = e3.data;
          if (n2 > 0.01) {
            const e4 = g(t2.buffer), n3 = this.audioEventId++;
  ...
  var k = class _k extends r2 {
    static async startSession(e2) {
      ...
      let n = null;
      try {
        return await C(t.connectionDelay), n = await S(e2), new _k(t, n);
      } catch (e3) {
        var o2;
  ...
  var I = class _I {
    static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: i, libsampleratePath: a2, onError: r3 }) {
      let c2 = null, l2 = null;
      try {
        const u3 = s({ sampleRate: { ideal: e2 } }, R);
        if (E() && n) {
          ...
          e3 && (u3.deviceId = { ideal: e3.deviceId });
        }
        o2 && (u3.deviceId = _I.getDeviceIdConstraint(o2));
        const d3 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
        c2 = new window.AudioContext(d3 ? { sampleRate: e2 } : {});
        const h3 = c2.createAnalyser();
        if (!d3) {
          const e3 = a2 || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
          await c2.audioWorklet.addModule(e3);
        }
        await b(c2.audioWorklet, null == i ? void 0 : i.rawAudioProcessor);
        const p2 = s({ voiceIsolation: true }, u3);
        l2 = await navigator.mediaDevices.getUserMedia({ audio: p2 });
        const m2 = c2.createMediaStreamSource(l2), v2 = new AudioWorkletNode(c2, "rawAudioProcessor");
        v2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), m2.connect(h3), h3.connect(v2), await c2.resume();
        const g2 = await navigator.permissions.query({ name: "microphone" });
        return new _I(c2, h3, v2, l2, m2, g2, r3);
      } catch (e3) {
        var u2, d2;
        throw null == (u2 = l2) || u2.getTracks().forEach((e4) => {
          e4.stop();
        }), null == (d2 = c2) || d2.close(), e3;
      }
    }
    static getDeviceIdConstraint(e2) {
      if (e2) return E() ? { ideal: e2 } : { exact: e2 };
    }
    constructor(e2, t, n, o2, i, s2, a2 = console.error) {
      this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.permissions = void 0, this.onError = void 0, this.settingInput = false, this.handlePermissionsChange = () => {
        if ("denied" === this.permissions.state) this.onError("Microphone permission denied");
        else if (!this.settingInput) {
          var e3;
          const [t2] = this.inputStream.getAudioTracks(), { deviceId: n2 } = null != (e3 = null == t2 ? void 0 : t2.getSettings()) ? e3 : {};
          this.setInputDevice(n2).catch((e4) => {
            this.onError("Failed to reset input device after permission change:", e4);
          });
        }
      }, this.context = e2, this.analyser = t, this.worklet = n, this.inputStream = o2, this.mediaStreamSource = i, this.permissions = s2, this.onError = a2, this.permissions.addEventListener("change", this.handlePermissionsChange);
    }
    forgetInputStreamAndSource() {
      for (const e2 of this.inputStream.getTracks()) e2.stop();
    ...
    async setInputDevice(e2) {
      try {
        ...
        const t = s({}, R);
        e2 && (t.deviceId = _I.getDeviceIdConstraint(e2));
        const n = s({ voiceIsolation: true }, t), o2 = await navigator.mediaDevices.getUserMedia({ audio: n });
        this.forgetInputStreamAndSource(), this.inputStream = o2, this.mediaStreamSource = this.context.createMediaStreamSource(o2), this.mediaStreamSource.connect(this.analyser);
      } catch (e3) {
        throw this.onError("Failed to switch input device:", e3), e3;
      } finally {
        this.settingInput = false;
      }
    }
  };
  var M = w("audioConcatProcessor", '/*\n * ulaw decoding logic taken from the wavefile library\n * https://github.com/rochars/wavefile/blob/master/lib/codecs/mulaw.js\n * USED BY @elevenlabs/client\n */\n\nconst decodeTable = [0,132,396,924,1980,4092,8316,16764];\n\nfunction decodeSample(muLawSample) {\n  let sign;\n  let exponent;\n  let mantissa;\n  let sample;\n  muLawSample = ~muLawSample;\n  sign = (muLawSample & 0x80);\n  exponent = (muLawSample >> 4) & 0x07;\n  mantissa = muLawSample & 0x0F;\n  sample = decodeTable[exponent] + (mantissa << (exponent+3));\n  if (sign !== 0) sample = -sample;\n\n  return sample;\n}\n\nclass AudioConcatProcessor extends AudioWorkletProcessor {\n  constructor() {\n    super();\n    this.buffers = []; // Initialize an empty buffer\n    this.cursor = 0;\n    this.currentBuffer = null;\n    this.wasInterrupted = false;\n    this.finished = false;\n    \n    this.port.onmessage = ({ data }) => {\n      switch (data.type) {\n        case "setFormat":\n          this.format = data.format;\n          break;\n        case "buffer":\n          this.wasInterrupted = false;\n          this.buffers.push(\n            this.format === "ulaw"\n              ? new Uint8Array(data.buffer)\n              : new Int16Array(data.buffer)\n          );\n          break;\n        case "interrupt":\n          this.wasInterrupted = true;\n          break;\n        case "clearInterrupted":\n          if (this.wasInterrupted) {\n            this.wasInterrupted = false;\n            this.buffers = [];\n            this.currentBuffer = null;\n          }\n      }\n    };\n  }\n  process(_, outputs) {\n    let finished = false;\n    const output = outputs[0][0];\n    for (let i = 0; i < output.length; i++) {\n      if (!this.currentBuffer) {\n        if (this.buffers.length === 0) {\n          finished = true;\n          break;\n        }\n        this.currentBuffer = this.buffers.shift();\n        this.cursor = 0;\n      }\n\n      let value = this.currentBuffer[this.cursor];\n      if (this.format === "ulaw") {\n        value = decodeSample(value);\n      }\n      output[i] = value / 32768;\n      this.cursor++;\n\n      if (this.cursor >= this.currentBuffer.length) {\n        this.currentBuffer = null;\n      }\n    }\n\n    if (this.finished !== finished) {\n      this.finished = finished;\n      this.port.postMessage({ type: "process", finished });\n    }\n\n    return true; // Continue processing\n  }\n}\n\nregisterProcessor("audioConcatProcessor", AudioConcatProcessor);\n');
  var A = class _A {
    static async create({ sampleRate: e2, format: t, outputDeviceId: n, workletPaths: o2 }) {
      let i = null, s2 = null;
      try {
        i = new AudioContext({ sampleRate: e2 });
        const a3 = i.createAnalyser(), r4 = i.createGain();
        s2 = new Audio(), s2.src = "", s2.load(), s2.autoplay = true, s2.style.display = "none", document.body.appendChild(s2);
        const c2 = i.createMediaStreamDestination();
        s2.srcObject = c2.stream, r4.connect(a3), a3.connect(c2), await M(i.audioWorklet, null == o2 ? void 0 : o2.audioConcatProcessor);
        const l2 = new AudioWorkletNode(i, "audioConcatProcessor");
        return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r4), await i.resume(), n && s2.setSinkId && await s2.setSinkId(n), new _A(i, a3, r4, l2, s2);
      } catch (e3) {
        var a2, r3;
        throw null != (a2 = s2) && a2.parentNode && s2.parentNode.removeChild(s2), null == (r3 = s2) || r3.pause(), i && "closed" !== i.state && await i.close(), e3;
      }
    }
    constructor(e2, t, n, o2, i) {
      this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e2, this.analyser = t, this.gain = n, this.worklet = o2, this.audioElement = i;
    }
  ...
  var D = class _D extends r2 {
    ...
    static async startSession(e2) {
      ...
      let o2 = null, i = null, a2 = null, c2 = null, l2 = null;
      (null == (t = e2.useWakeLock) || t) && (l2 = await _D.requestWakeLock());
      try {
        var u2;
        return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await C(n.connectionDelay), i = await S(e2), [o2, a2] = await Promise.all([I.create(s({}, i.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices, inputDeviceId: e2.inputDeviceId, workletPaths: e2.workletPaths, libsampleratePath: e2.libsampleratePath })), A.create(s({}, i.outputFormat, { outputDeviceId: e2.outputDeviceId, workletPaths: e2.workletPaths }))]), null == (u2 = c2) || u2.getTracks().forEach((e3) => {
          e3.stop();
        }), c2 = null, new _D(n, i, o2, a2, l2);
      } catch (e3) {
        var d2, h3, p2, m2;
        n.onStatusChange && n.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e4) => {
          e4.stop();
        }), null == (h3 = i) || h3.close(), await (null == (p2 = o2) ? void 0 : p2.close()), await (null == (m2 = a2) ? void 0 : m2.close());
        try {
          var v2;
    ...
    constructor(e2, t, n, o2, i) {
      super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.visibilityChangeHandler = null, this.onInputWorkletMessage = (e3) => {
        "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: g(e3.data[0].buffer) });
        ...
        this.output.gain.gain.cancelScheduledValues(this.output.context.currentTime), this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: f(e3) });
      }, this.fadeOutAudio = () => {
      ...
      }, this.input = n, this.output = o2, this.wakeLock = i, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage, i && (this.visibilityChangeHandler = () => {
        var e3;
        "visible" === document.visibilityState && null != (e3 = this.wakeLock) && e3.released && _D.requestWakeLock().then((e4) => {
          this.wakeLock = e4;
        });
    ...
    handleAudio(e2) {
      var t, n;
      super.handleAudio(e2), e2.audio_event.alignment && this.options.onAudioAlignment && this.options.onAudioAlignment(e2.audio_event.alignment), this.lastInterruptTimestamp <= e2.audio_event.event_id && (e2.audio_event.audio_base_64 && (null == (t = (n = this.options).onAudio) || t.call(n, e2.audio_event.audio_base_64), this.connection instanceof y || this.addAudioBase64Chunk(e2.audio_event.audio_base_64)), this.currentEventId = e2.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
    }
    setMicMuted(e2) {
    ...
    async changeInputDevice({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o2 }) {
      try {
        ...
        const i = await I.create({ sampleRate: null != e2 ? e2 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n, inputDeviceId: o2, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath, onError: this.options.onError });
    ...
    async changeOutputDevice({ sampleRate: e2, format: t, outputDeviceId: n }) {
      try {
        ...
        const o2 = await A.create({ sampleRate: null != e2 ? e2 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n, workletPaths: this.options.workletPaths });
  ...
  var x = class {
    constructor(e2) {
      this.websocket = null, this.eventEmitter = new F(), this.currentSampleRate = 16e3, this._audioCleanup = void 0, this.currentSampleRate = e2;
    }
    setWebSocket(e2) {
...
`);
  ...
  var N = class _N {
    static getWebSocketUri(e2 = _N.DEFAULT_BASE_URI) {
      return `${e2}/v1/speech-to-text/realtime`;
    }
    static buildWebSocketUri(e2) {
      const t = _N.getWebSocketUri(e2.baseUri), n = new URLSearchParams();
      if (n.append("model_id", e2.modelId), n.append("token", e2.token), void 0 !== e2.commitStrategy && n.append("commit_strategy", e2.commitStrategy), void 0 !== e2.audioFormat && n.append("audio_format", e2.audioFormat), void 0 !== e2.vadSilenceThresholdSecs) {
    ...
    static connect(e2) {
      ...
      const t = new x("microphone" in e2 && e2.microphone ? 16e3 : e2.sampleRate), n = _N.buildWebSocketUri(e2), o2 = new WebSocket(n);
      return "microphone" in e2 && e2.microphone && o2.addEventListener("open", () => {
        _N.streamFromMicrophone(e2, t);
      }), t.setWebSocket(o2), t;
    }
    static async streamFromMicrophone(e2, t) {
      const n = 16e3;
      try {
        var o2, i, s2, a2, r3, c2, l2, u2, d2, h3;
        const p2 = await navigator.mediaDevices.getUserMedia({ audio: { deviceId: null == (o2 = e2.microphone) ? void 0 : o2.deviceId, echoCancellation: null == (i = null == (s2 = e2.microphone) ? void 0 : s2.echoCancellation) || i, noiseSuppression: null == (a2 = null == (r3 = e2.microphone) ? void 0 : r3.noiseSuppression) || a2, autoGainControl: null == (c2 = null == (l2 = e2.microphone) ? void 0 : l2.autoGainControl) || c2, channelCount: null != (u2 = null == (d2 = e2.microphone) ? void 0 : d2.channelCount) ? u2 : 1, sampleRate: { ideal: n } } }), m2 = null == (h3 = p2.getAudioTracks()[0]) ? void 0 : h3.getSettings(), v2 = null == m2 ? void 0 : m2.sampleRate, g2 = new AudioContext(v2 ? { sampleRate: v2 } : {});
        await O(g2.audioWorklet);
        const f2 = g2.createMediaStreamSource(p2), _3 = new AudioWorkletNode(g2, "scribeAudioProcessor");
        g2.sampleRate !== n && _3.port.postMessage({ type: "configure", inputSampleRate: g2.sampleRate, outputSampleRate: n }), _3.port.onmessage = (e3) => {
          const { audioData: n2 } = e3.data, o3 = new Uint8Array(n2);
          let i2 = "";
          for (let e4 = 0; e4 < o3.length; e4++) i2 += String.fromCharCode(o3[e4]);
          const s3 = btoa(i2);
          t.send({ audioBase64: s3 });
        }, f2.connect(_3), "suspended" === g2.state && await g2.resume(), t._audioCleanup = () => {
          p2.getTracks().forEach((e3) => {
            e3.stop();
  ...
  var W = class _W extends r2 {
    static startSession(e2) {
      const t = _W.getFullOptions(e2);
      return t.textOnly ? k.startSession(t) : D.startSession(t);
    }
  };
    ...
    constructor(canvas) {
      ...
      for (let i = 0; i < this.lineCount; i++) {
        this.lines.push({
          ...
          yBase: i / (this.lineCount - 1) * 0.7 + 0.15,
          // 15%-85% of height
          // Unique wave parameters per line — bigger, slower, more dramatic
          freq1: 1 + Math.random() * 1,
          // primary wave frequency (lower = wider curves)
          freq2: 1.8 + Math.random() * 1.5,
          // secondary
          freq3: 0.5 + Math.random() * 0.6,
          // slow undulation
          amp1: 0.08 + Math.random() * 0.08,
          // amplitudes as % of height (bigger)
          amp2: 0.035 + Math.random() * 0.04,
          amp3: 0.05 + Math.random() * 0.05,
          speed1: 0.12 + Math.random() * 0.15,
          ...
          // start phase offset
          // Visual
          hue: 235 + Math.random() * 40,
          // blue-purple range
          alpha: 0.1 + Math.random() * 0.15,
          // slightly brighter since fewer lines
    ...
    _animate() {
      ...
      for (let i = 0; i < this.lineCount; i++) {
        ...
        for (let j = 0; j <= segmentCount; j++) {
          ...
          const wave1 = Math.sin(xNorm * Math.PI * line.freq1 + this.time * line.speed1 + line.phase) * h3 * line.amp1;
          const wave2 = Math.sin(xNorm * Math.PI * line.freq2 + this.time * line.speed2 + line.phase * 1.7) * h3 * line.amp2;
          const wave3 = Math.sin(xNorm * Math.PI * line.freq3 + this.time * line.speed3 + line.phase * 0.5) * h3 * line.amp3;
          const dx = xNorm - mx;
          const dy = line.yBase - my;
          const dist = Math.sqrt(dx * dx + dy * dy);
          const pull = Math.max(0, 1 - dist * 2.5) * h3 * 0.06;
          const mouseBend = pull * Math.sin((xNorm - mx) * Math.PI * 2);
          const y2 = baseY + wave1 + wave2 + wave3 + mouseBend;
          if (j === 0) {
            ctx.moveTo(x2, y2);
          } else {
            ctx.lineTo(x2, y2);
  ...
  (function() {
    ...
    async function submitText() {
      ...
      if (!text) {
        ui.toast("Please type a message first.");
        return;
      }
      ui.textInput.value = "";
